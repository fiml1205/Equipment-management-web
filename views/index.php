...
use Controllers\DevicesController;

include('../model/database/DbConnect.php');
include('../model/Devices/DevicesDb.php');
include('../model/Devices/Devices.php');
                                ...
                                foreach($result as $device) {
                                    ?>
                                        <tr>
                                            ...
                                            <td class="table-body"><?php echo $device->getMac() ?></td>
                                            <td class="table-body"><?php echo $device->getIp() ?></td>
                                            <td class="table-body"><?php echo $device->getDate() ?></td>
                                            <td class="table-foot"><?php echo $device->getPower() ?></td>
                                        </tr>
                                    <?php
                                }
                            ?>
